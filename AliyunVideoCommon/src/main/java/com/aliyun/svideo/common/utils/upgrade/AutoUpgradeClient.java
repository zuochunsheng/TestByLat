...
public class AutoUpgradeClient {
     ...
     * cdn加速域名
     */
    private static String UPGRADE_JSON_BASE_URL = "https://vod-download.cn-shanghai.aliyuncs.com";

    public static final String ALLMODULE_JSON = "/apsaravideo-upgrade/android/allmodule/oss_upgrade_allmodule.json";//allmodule
    /**
     * 临时apk文件的文件名头
     */
    ...
    private static Uri getUriForFile(Context context, File file) {
        ...
        if (Build.VERSION.SDK_INT >=  Build.VERSION_CODES.N) {
            uri = FileProvider.getUriForFile(context, FileUtils.getFileProviderName(context), file);
        } else {
