package com.android.superplayer.pulltorefresh;
...
import com.android.superplayer.util.Metrics;
    ...
    public void setRefreshHeader(View view) {
        if (view != null && view != refreshHeader) {
            ...
            if (layoutParams == null) {
                layoutParams = new LayoutParams(LayoutParams.MATCH_PARENT, Metrics.dip2px(getContext(), 120));//Metrics.dip2px(getContext(), 100))
...
//        Log.e(TAG, "moveSpinner: currentTargetOffsetTop = "+ currentTargetOffsetTop);
    ...
    public boolean canChildScrollUp() {// 目前 最低 15
    ...
    public enum State {
        RESET, PULL, LOADING, COMPLETE, FAIL
    }
